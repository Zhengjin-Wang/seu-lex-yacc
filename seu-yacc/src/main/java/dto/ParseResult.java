...
public class ParseResult {
    ...
    // part2获取的信息
    private List<String> nonTerminals = new ArrayList<>(); // 非终结符集合
    ...
    private List<List<String>> extendedProductionList = new ArrayList<>();
    private Map<List<String>, Integer> extendedProductionPriority = new HashMap<>();
